...
$(document).ready(function() {
	...
	$("#messages").jqGrid({
	    ...
	    colNames:['Date','Time','From','Message'],
	    colModel:[
...
function selectRow () {
	...
	document.getElementById('key').value=jQuery('#messages').jqGrid('getGridParam','selrow');
}
</script>


	<table id="messages" class="scroll" cellpadding="0" cellspacing="0" width="50%" >
	</table>
	
	<div id="messages1" class="scroll" style="text-align: center;"></div>
